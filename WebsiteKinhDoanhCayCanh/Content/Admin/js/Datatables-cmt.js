                                    ...
                                    var T = (function () {
                                            ...
                                            return (
                                                ...
                                                (m.isSame = function (t, e) {
                                                    var s = x(t);
                                                    return (
                                                        this.startOf(e) <= s && s <= this.endOf(e)
                                                    );
                                                }),
            ...
            2: [
                function (t, e, s) {
                    ...
                    const i = (t) => "[object Object]" === Object.prototype.toString.call(t),
                        ...
                        r = (t, e, s) =>
                            a("li", { class: t, html: `<a href="#" data-page="${e}">${s}</a>` }),
                        o = (t, e) => {
                            let s, i;
                            1 === e
                                ? ((s = 0), (i = t.length))
                    ...
                    class l {
                        ...
                        sort(e, s, i) {
                            ...
                            const n =
                                a.options.filters && a.options.filters[a.headings[e].textContent];
                    ...
                    s.DataTable = class {
                        ...
                        export(t) {
                            ...
                            if (l.type) {
                                if (
                                    (("txt" !== l.type && "csv" !== l.type) || (s[0] = this.header),
                                    l.selection)
                                )
